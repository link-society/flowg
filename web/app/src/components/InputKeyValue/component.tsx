...
import { InputKVRoot, InputKVRow } from './styles'

type KeyValue = [string, string]

type InputKeyValueProps = Readonly<{
  id?: string
  keyLabel?: string
  valueLabel?: string
  keyValues: KeyValue[]
...
const InputKeyValue = (props: InputKeyValueProps) => {
  ...
  return (
    <InputKVRoot id={props.id ?? 'field:generic.kv-editor'}>
