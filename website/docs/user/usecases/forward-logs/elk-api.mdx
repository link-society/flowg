...
<ForwarderForm
  forwarderType="Elastic Search"
  fields={[
    { label: 'Index', value: 'default', tooltip: 'The ElasticSearch index logs will be written to.' },
    { label: 'Username', value: 'flowg', tooltip: 'The name of the user we just created.' },
    { type: 'password', label: 'Password', tooltip: 'The password of the user we just created.' },
    { type: 'divider' },
    { label: 'Address', value: 'https://localhost:9200', tooltip: 'URLs pointing to your ElasticSearch cluster.' },
    { type: 'divider' },
    { type: 'textarea', label: 'CA Certificate', value: '-----BEGIN CERTIFICATE-----\n...\n-----END CERTIFICATE-----', tooltip: 'Used to validate the ElasticSearch server certificate.' },
  ]}
/>
...
<PipelineDiagram
  alt="A FlowG pipeline routing syslog logs to the ElasticSearch forwarder"
  nodes={[
    { id: 'source', type: 'source', x: 0, y: 0, value: 'SYSLOG' },
    { id: 'fwd', type: 'forwarder', x: 340, y: 0, value: 'es' },
  ]}
  edges={[
    { from: 'source', to: 'fwd' },
  ]}
