...
| Tag | (static) `flowg` | You can use any static value or expression you want actually |
| Severity | (static) `INFO` | You can use any static value or expression you want |
| Facility | (static) `LOCAL0` | You can use any static value or expression you want |
| Message | (expression) `toJSON(log)` | The output must be a JSON because of how we configured Logstash |
