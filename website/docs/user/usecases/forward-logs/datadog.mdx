...
<ForwarderForm
  ...
  fields={[
    { label: 'URL', value: 'https://http-intake.logs.datadoghq.com/api/v2/logs', tooltip: 'The HTTP intake endpoint. Must match your Datadog region.' },
    { type: 'divider' },
    { type: 'password', label: 'ApiKey', tooltip: 'An API Key created in your Datadog account.' },
  ]}
/>
...
<PipelineDiagram
  alt="A FlowG pipeline transforming and routing syslog logs to the Datadog forwarder"
  nodes={[
    { id: 'source', type: 'source', x: 0, y: 0, value: 'SYSLOG' },
    { id: 'transformer', type: 'transformer', x: 340, y: 0, value: 'prepare-dd' },
    { id: 'fwd', type: 'forwarder', x: 680, y: 0, value: 'dd' },
  ]}
  edges={[
    { from: 'source', to: 'transformer' },
    { from: 'transformer', to: 'fwd' },
  ]}
/>
