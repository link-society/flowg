...
@pytest.fixture(scope='module')
def dns_image():
    img = os.getenv("FLOWG_TEST_DOCKER_DNS_IMAGE_NAME", "linksociety/dns:latest")
...
@pytest.fixture(scope='module')
def flowg_dns_image():
    img = os.getenv("FLOWG_TEST_DOCKER_FLOWG_DNS_IMAGE_NAME", "linksociety/flowg-dns:latest")
    print(f"Using Flowg Docker image: {img}")
    return img
