...
The package at `internal/storage/backends/badger/concrete/auth/transactions`
holds the low-level read/write operations behind the auth backend. Each function
takes a Badger transaction and manipulates the auth key space directly; this
